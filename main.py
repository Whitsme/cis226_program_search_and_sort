...
# Create Items
node_1 = Node('1')
node_2 = Node('7', prev=node_1)
node_3 = Node('4', prev=node_2)
node_4 = Node('2', prev=node_3)
node_5 = Node('9', prev=node_4)
node_6 = Node('8', prev=node_5)
node_7 = Node('10', prev=node_6)
node_8 = Node('-4', prev=node_7)
node_9 = Node('0', prev=node_8)
node_10 = Node('3', prev=node_9)
